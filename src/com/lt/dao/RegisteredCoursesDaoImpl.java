...
public class RegisteredCoursesDaoImpl implements RegisteredCoursesDao{
	...
	private static RegisteredCoursesDaoImpl registerCourseDao = null;
	
	private static Logger logger = Logger.getLogger(RegisteredCoursesDaoImpl.class);
	private PreparedStatement stmt = null;
	
	//Private Constructor for RegisteredCoursesDaoImpl
	...
	{
		if(registerCourseDao == null)
		{
			synchronized (RegisteredCoursesDaoImpl.class) {
				registerCourseDao = new RegisteredCoursesDaoImpl();
				
			}
		}
		return registerCourseDao;
	}
